...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $password === '') {
        ...
        $sql = "SELECT u.*, r.name AS role_name
                ...
                WHERE sp.enrollment_no = :enrollment_id
                  AND r.name = 'student'
                LIMIT 1";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([':enrollment_id' => $username]);
        $user = $stmt->fetch();
...
<head>
    <meta charset="UTF-8">
    <title>Student Login - College Management System</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-5">
            <div class="card shadow-lg border-0 login-card">
                <div class="card-header text-center py-4" style="background: linear-gradient(135deg, #198754 0%, #157347 100%);">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" autocomplete="off">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="username" class="form-control" placeholder="Enter your Enrollment ID" required autofocus>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="mt-3 text-center">
                        <a href="<?php echo BASE_URL; ?>/student/register.php" class="btn btn-outline-success">Register as Student</a>
                    </div>
                </div>
